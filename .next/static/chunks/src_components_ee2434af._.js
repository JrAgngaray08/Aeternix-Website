(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_components_ee2434af._.js", {
...
const Navbar = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Navbar.useEffect": ()=>{
            ...
            const directPageNavItem = navItems.find({
                "Navbar.useEffect.directPageNavItem": (item)=>item.href === pathname && !item.href.includes('#')
            }["Navbar.useEffect.directPageNavItem"]);
                        ...
                        "Navbar.useEffect.observerCallback": (entry)=>{
                            if (entry.isIntersecting) {
                                ...
                                const navItem = navItems.find({
                                    "Navbar.useEffect.observerCallback.navItem": (item)=>item.sectionId === entry.target.id && item.href.startsWith('/#')
                                }["Navbar.useEffect.observerCallback.navItem"]);
                                if (navItem) {
            ...
            sections.forEach({
                "Navbar.useEffect": (section)=>{
                    if (navItems.some({
                        "Navbar.useEffect": (item)=>item.sectionId === section.id && item.href.startsWith('/#')
                    }["Navbar.useEffect"])) {
            ...
            if (pathname === '/') {
                ...
                const navItemForHash = navItems.find({
                    "Navbar.useEffect.navItemForHash": (item)=>item.sectionId === currentHash && item.href.startsWith('/#')
                }["Navbar.useEffect.navItemForHash"]);
                if (navItemForHash) {
                    ...
                    for (const sectionEl of Array.from(sections)){
                        ...
                        if (navItems.some({
                            "Navbar.useEffect": (item)=>item.sectionId === sectionEl.id && item.href.startsWith('/#')
                        }["Navbar.useEffect"])) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("fixed top-4 left-1/2 z-50 -translate-x-1/2 transition-all duration-300 ease-in-out"),
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("flex h-14 sm:h-[60px] items-center justify-center gap-x-6 rounded-full px-6 sm:px-8 shadow-2xl", "bg-neutral-900/80 backdrop-blur-lg"),
                children: [
...
//# sourceMappingURL=src_components_ee2434af._.js.map